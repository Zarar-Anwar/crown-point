...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Simple REST APIs, webhooks, and plugins make it easy to integrate CrownPoint with your existing systems, e-commerce platforms, and accounting software.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
